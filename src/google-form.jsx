...
import "./google.css";
class GoogleForm1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      firstname: '',
    ...
    return (
      ...
      <form className='parent_container' onSubmit={this.handleSubmit}>
       ...
       <div>{errors.email}</div>
        ...
        <br />
        <p className="2">you can use letters,numbers & periods</p>
        
        <h4 className="2">use my current email address instead</h4>
